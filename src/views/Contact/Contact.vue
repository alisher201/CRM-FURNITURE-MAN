...
<template>
  <div class="p-3">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <form action="#" @submit.prevent="addContact">
            <div class="grid gap-4 mb-4 sm:grid-cols-1">
              <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tel:</label>
                <input type="tel" name="name" id="name"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  placeholder="Telefon raqam kiriting" required="" v-model="number" />
              </div>
            </div>
            <button type="submit"
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr v-for="el in state.LIST" :key="el.id" class="border-b dark:border-gray-700">
                  ...
                  <td class="px-4 py-3">
                    <span v-if="el.status" class="bg-green-300 text-center p-2 rounded-xl block w-[60px]">Yangi</span>
                    <span v-else class="bg-red-300 text-center p-2 rounded-xl block w-[60px]">Mavjud emas</span>
                  </td>
                  <td class="px-4 py-3">
                    <button @click="togglePopUp(el.id)"
    ...
    <div id="popup-modal" tabindex="-1" :class="popUp
      ...
      <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="p-6 text-center">
            ...
            <button @click="senID" data-modal-hide="popup-modal" type="button"
